...
// the pattern will be alwais chessboard, this part of code can be removed
...
int main( int argc, char** argv )
{
    ...
    Mat cameraMatrix, distCoeffs, chessboardMatrix;
	...
	vector<Point2f> cornersPattern;
	bool found2 = findChessboardCorners( chessboardMatrix, boardSize, cornersPattern,
    ...
    for(i = 0;;i++)
    {
       ...
       // improve the found corners' coordinate accuracy
        ...
        if( mode == CALIBRATED && undistortImage )
        {
            ...
            if(found){
            	Mat H = findHomography(pointbuf, cornersPattern);
